...
export class CreatePetUseCase {
    ...
    async execute({ name, about, age, size, energy, environment, independence, requirements, organizationId, photos }: CreatePetUseCaseRequest): Promise<CreatePetUseCaseResponse> {
